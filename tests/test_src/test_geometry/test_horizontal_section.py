...
from src.geometry.horizontal_section import (
    create_horizontal_section_annotations,
    create_horizontal_section_view 
)
...
class TestHorizontalSection(unittest.TestCase):
    ...
    def _create_default_params_for_annotations(self, num_segments=1, horizontal_section_loc= -1.0) -> Munch:
        ...
        return Munch({
            ...
            "input": Munch({"dimensions": Munch({"horizontal_section_loc": horizontal_section_loc})})
        })
    ...
    def test_create_horizontal_section_view_basic_flow(
        self, 
        mock_create_horizontal_annotations,
        mock_model_creator_create_cross_section, 
        mock_trimesh_module, 
        ...
        mock_entity1 = MagicMock(); mock_entity1.points = [0,1,2]
